...
function showBrnPop() {
	...
	document.getElementById("pbbaLogoFocus").style.display = "none";
	document.getElementById("pbbaLogoFocus2").style.display = "block";
	document.getElementById("pbbaLogoFocus2").focus();
